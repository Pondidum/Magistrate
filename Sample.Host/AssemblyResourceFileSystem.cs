...
namespace Sample.Host
{
	public class AssemblyResourceFileSystem : IFileSystem
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="AssemblyResourceFileSystem" /> class using the calling
		/// assembly and empty base namespace.
		/// </summary>
		public AssemblyResourceFileSystem()
			: this(Assembly.GetCallingAssembly())
		{
		}

		/// <summary>
		/// Initializes a new instance of the <see cref="AssemblyResourceFileSystem" /> class using the specified
		/// assembly and empty base namespace.
		/// </summary>
		/// <param name="assembly"></param>
		public AssemblyResourceFileSystem(Assembly assembly)
		...
		public AssemblyResourceFileSystem(string baseNamespace)
		...
		/// <param name="baseNamespace">The base namespace that contains the embedded resources.</param>
		public AssemblyResourceFileSystem(Assembly assembly, string baseNamespace)
		{
			if (assembly == null)
			{
