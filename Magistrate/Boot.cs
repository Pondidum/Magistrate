...
namespace Magistrate
{
	public class Boot
	{
		...
		public Boot(Projectionist projectionist, AggregateStore<Guid> store, UserService users, RoleService roles, PermissionService permissions, AllCollections collections)
		{
